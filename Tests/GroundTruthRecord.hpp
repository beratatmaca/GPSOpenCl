#ifndef INCLUDED_GPSOPENCLTEST_GROUNDTRUTHRECORD_HPP
#define INCLUDED_GPSOPENCLTEST_GROUNDTRUTHRECORD_HPP
...
#endif    //! INCLUDED_GPSOPENCLTEST_GROUNDTRUTHRECORD_HPP
